...
export const STRINGS_PT_BR: TranslationStrings = {
    commands: {
        paste: 'Colar',
        pasteRaw: 'Colar como texto simples',
    ...
    settings: {
        ...
        images: {
            heading: 'Anexos',
            fileModeName: 'Arquivos colados',
            fileModeDesc:
                'Escolha o que acontece quando você cola arquivos do seu dispositivo, como PDF e capturas de tela. "Não fazer nada" deixa a colagem por conta do Obsidian, pré-visualização incluída. "Vincular sem pré-visualização" remove o ponto de exclamação.',
            fileModeChoiceOff: 'Não fazer nada',
            fileModeChoiceLink: 'Vincular sem pré-visualização',
            fileModeAliases: [
                'arquivo',
                'anexo',
                'pré-visualização',
            ...
            namingInfoTitle: 'Quando o formato do nome de arquivo se aplica',
            namingInfoLead: 'Importante! O Better Paste não consegue fazer o seguinte:',
            namingInfoExplorer: 'Renomear um arquivo que você copia no Finder ou no Explorador de Arquivos e cola',
            namingInfoDrag: 'Renomear um arquivo que você arrasta para uma nota',
            namingInfoMobile: 'Processar o que é colado com o comando Colar do Obsidian no celular. Use "{command}" no lugar.',
        ...
        structure: {
            ...
            quoteContinuationDesc:
                'Cola texto com várias linhas em uma linha citada e cita todas as linhas, para que todo o conteúdo colado permaneça dentro da citação em bloco ou do destaque.',
        ...
        custom: {
            ...
            snippetsName: 'Trechos de texto',
            snippetsDesc: 'Aplicados a todo o texto colado depois das regras integradas. Ative os que devem ser executados ao colar.',
            urlSnippetsName: 'Trechos de link',
            urlSnippetsDesc:
                'Aplicados a cada link colado depois que o título da página é obtido. As regras veem apenas o link Markdown final, e o destino permanece inalterado.',
            ...
            urlPreviewDesc: 'Cole um link Markdown para ver o resultado de todos os trechos de link ativados.',
            urlModalPreviewDesc: 'Cole um link Markdown para ver o resultado deste trecho.',
            urlPreviewLabel: 'Link com título de exemplo',
            urlPreviewEmpty: 'O link processado aparece aqui.',
            nameName: 'Nome',
            rulesName: 'Regras',
    ...
    overlap: {
        ...
        intro: {
            one: 'No momento você tem {count} plugin instalado que faz mais ou menos a mesma coisa que o Better Paste, então desative ou desinstale:',
            other: 'No momento você tem {count} plugins instalados que fazem mais ou menos a mesma coisa que o Better Paste, então desative ou desinstale:'
        },
