...
export const STRINGS_ES: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            savingDesc:
                'Elige si quieres enlazar las imágenes directamente desde la web o descargarlas en tu carpeta de adjuntos. Abarca "Copiar imagen" de Safari, las imágenes dentro de contenido web copiado y las direcciones de imagen pegadas. Por defecto, el nombre del archivo procede de la dirección:',
        ...
        custom: {
            ...
            urlPreviewDesc: 'Edita el enlace con título de ejemplo para ver el resultado de todos los fragmentos de enlace activados.',
            urlModalPreviewDesc: 'Edita el enlace con título de ejemplo para ver el resultado de este fragmento.',
