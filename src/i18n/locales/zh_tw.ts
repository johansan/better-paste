...
export const STRINGS_ZH_TW: TranslationStrings = {
    ...
    settings: {
        ...
        text: {
            ...
            invisibleAliases: ['ai', 'chatgpt', 'claude', 'llm', 'unicode', '不可見', 'nbsp', '空白'],
            ...
            quotesAliases: ['引號', '彎引號', '直引號', '撇號', '標點', '排版', 'ai'],
            quotesNone: '不做變動',
            quotesStraight: '直引號',
            quotesCurly: '彎引號',
            ...
            dashesAliases: ['破折號', '長破折號', '連接號', '連字號', '標點', '排版', 'ai'],
            dashesNone: '不做變動',
            dashesHyphen: '連字號',
            dashesEn: '連接號',
            dashesEm: '長破折號',
            dashesEmSpaced: '帶空格的長破折號',
