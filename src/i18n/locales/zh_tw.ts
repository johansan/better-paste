...
export const STRINGS_ZH_TW: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            namingInfoLead: '重要！Better Paste 無法做到以下幾點：',
            namingInfoExplorer: '重新命名在 Finder 或檔案總管中複製後貼上的檔案',
            namingInfoDrag: '重新命名拖進筆記的檔案',
            namingInfoMobile: '處理在行動裝置上用 Obsidian 內建貼上指令貼上的內容。請改用「{command}」。',
