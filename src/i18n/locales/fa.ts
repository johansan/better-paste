...
export const STRINGS_FA: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            savingDesc:
                'انتخاب کنید که تصاویر مستقیماً از وب پیوند داده شوند یا در پوشه پیوست‌های شما دانلود شوند. شامل «کپی تصویر» در Safari، تصاویر درون محتوای وب کپی‌شده و نشانی‌های تصویر چسبانده‌شده است. نام پرونده به‌طور پیش‌فرض از نشانی گرفته می‌شود:',
