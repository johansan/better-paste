...
export const STRINGS_FA: TranslationStrings = {
    ...
    settings: {
        ...
        behavior: {
            ...
            autoCleanDesc:
                'قوانین را در هر چسباندن اعمال می‌کند. وقتی خاموش باشد، قوانین فقط از طریق دستورهای Better Paste اجرا می‌شوند. یک یادداشت می‌تواند با ویژگی "better-paste: false" خود را کنار بگذارد.',
