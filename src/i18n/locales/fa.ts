...
export const STRINGS_FA: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            heading: 'تصاویر',
            savingName: 'ذخیره تصاویر وب در گاوصندوق',
            savingDesc:
                'تصاویر وب را در پوشه پیوست‌های شما ذخیره می‌کند و به جای نشانی وب به پرونده محلی پیوند می‌دهد. شامل «کپی تصویر» در Safari، تصاویر درون محتوای وب کپی‌شده و نشانی‌های تصویر چسبانده‌شده است. نام پرونده به‌طور پیش‌فرض از نشانی گرفته می‌شود:',
            savingAliases: ['دانلود', 'url', 'وب', 'پیوست', 'safari', 'محلی', 'تصویر', 'پوشه'],
