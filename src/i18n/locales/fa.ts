...
export const STRINGS_FA: TranslationStrings = {
    ...
    settings: {
        ...
        text: {
            ...
            quotesAliases: ['گیومه', 'گیومه فرفری', 'گیومه راست', 'آپاستروف', 'نشانه‌گذاری', 'تایپوگرافی', 'هوش مصنوعی'],
            quotesNone: 'بدون تغییر',
            quotesStraight: 'گیومه راست',
            quotesCurly: 'گیومه فرفری',
            quotesExample: '“تمام شد,” و سپس "ادامه".',
            dashesName: 'خط تیره',
            dashesDesc: 'خط تیره‌های میان واژه‌ها را به این سبک تبدیل می‌کند.',
            dashesAliases: ['خط تیره', 'خط تیره بلند', 'نیم‌خط', 'خط پیوند', 'نشانه‌گذاری', 'تایپوگرافی', 'هوش مصنوعی'],
