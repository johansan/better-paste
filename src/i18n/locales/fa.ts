...
export const STRINGS_FA: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            heading: 'پیوست‌ها',
            fileModeName: 'پرونده‌های چسبانده‌شده',
            fileModeDesc:
                'انتخاب کنید هنگام چسباندن پرونده‌ها از دستگاه شما، مانند PDF و نماگرفت‌ها، چه اتفاقی بیفتد. «کاری انجام نشود» چسباندن را همراه با پیش‌نمایش به خود Obsidian واگذار می‌کند و «پیوند بدون پیش‌نمایش» علامت تعجب را حذف می‌کند.',
            fileModeChoiceOff: 'کاری انجام نشود',
            fileModeChoiceLink: 'پیوند بدون پیش‌نمایش',
            fileModeAliases: ['پرونده', 'پیوست', 'پیش‌نمایش', 'جاسازی', 'پیوند', 'pdf', 'نماگرفت', 'علامت تعجب'],
            savingName: 'تصاویر وب',
            savingDesc:
                'انتخاب کنید هنگام چسباندن پیوندهای تصاویر وب چه اتفاقی بیفتد. «کاری انجام نشود» محتوای چسبانده‌شده را دست‌نخورده می‌گذارد، «پیوند با پیش‌نمایش» تصویر را مستقیماً از وب نشان می‌دهد و «دانلود با پیش‌نمایش» نسخه‌ای از هر تصویر را در گاوصندوق شما ذخیره می‌کند.',
        ...
        links: {
            ...
            titlesDesc:
                'چسباندن یک نشانی وب به‌تنهایی، پیوند Markdown با عنوان صفحه درج می‌کند. چسباندن نشانی Obsidian پیوندی با نام یادداشت درج می‌کند. اگر متنی انتخاب شده باشد، همان متن برچسب می‌شود و عنوانی دریافت نمی‌شود. اگر عنوان به دست نیاید، خود نشانی باقی می‌ماند.',
