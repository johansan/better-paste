...
export const STRINGS_RU: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            savingDesc:
                'Выберите, вставлять ли изображения по ссылке прямо из веба или скачивать их в папку вложений. Касается команды «Скопировать изображение» в Safari, изображений внутри скопированного веб-содержимого и вставленных адресов изображений. По умолчанию имя файла берётся из адреса:',
