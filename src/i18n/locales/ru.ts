...
export const STRINGS_RU: TranslationStrings = {
    ...
    settings: {
        ...
        text: {
            ...
            quotesName: 'Кавычки',
            quotesDesc: 'Преобразует кавычки и апострофы в этот стиль.',
            quotesAliases: ['кавычки', 'фигурные кавычки', 'прямые кавычки', 'апостроф', 'пунктуация', 'типографика', 'ии'],
            quotesNone: 'Без изменений',
            quotesStraight: 'Прямые кавычки',
            quotesCurly: 'Фигурные кавычки',
            quotesExample: '“Готово,” сказала она. Всё "хорошо".',
            dashesName: 'Тире',
            dashesDesc: 'Преобразует тире между словами в этот стиль.',
            dashesAliases: ['тире', 'длинное тире', 'среднее тире', 'дефис', 'пунктуация', 'типографика', 'ии'],
