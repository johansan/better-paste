...
export const STRINGS_RU: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            savingDesc:
                'Выберите, что происходит при вставке изображений из веба. «Ничего не делать» оставляет вставку как есть, «Вставлять ссылку с предпросмотром» показывает изображение прямо из веба, а «Скачивать с предпросмотром» сохраняет копию в хранилище, включая изображения, скопированные в Safari.',
