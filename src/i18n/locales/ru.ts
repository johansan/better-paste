...
export const STRINGS_RU: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            heading: 'Вложения',
            fileModeName: 'Вставленные файлы',
            fileModeDesc:
                'Выберите, что происходит при вставке файлов с вашего устройства, например PDF и снимков экрана. «Ничего не делать» оставляет вставку самому Obsidian, включая предпросмотр. «Вставлять ссылку без предпросмотра» убирает восклицательный знак.',
            fileModeChoiceOff: 'Ничего не делать',
            fileModeChoiceLink: 'Вставлять ссылку без предпросмотра',
            fileModeAliases: ['файл', 'вложение', 'предпросмотр', 'встроить', 'ссылка', 'pdf', 'снимок экрана', 'восклицательный знак'],
