...
export const STRINGS_RU: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            heading: 'Изображения',
            savingName: 'Сохранять веб-изображения в хранилище',
            savingDesc:
                'Сохраняет веб-изображения в папку вложений и ссылается на локальный файл вместо веб-адреса. Касается «Скопировать изображение» в Safari, изображений внутри скопированного веб-содержимого и вставленных адресов изображений. По умолчанию имя файла берётся из адреса:',
            savingAliases: ['скачать', 'url', 'веб', 'вложение', 'safari', 'локальный', 'изображение', 'папка'],
