...
export const STRINGS_FR: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            namingInfoTitle: 'Quand le format de nom de fichier s’applique',
            namingInfoLead: 'Important ! Voici ce que Better Paste ne peut pas faire :',
            namingInfoExplorer: 'Renommer un fichier que vous copiez dans le Finder ou l’Explorateur et collez',
            namingInfoDrag: 'Renommer un fichier que vous glissez dans une note',
            namingInfoMobile: 'Traiter un collage fait avec la commande Coller d’Obsidian sur mobile. Utilisez « {command} » à la place.',
        ...
        custom: {
            ...
            snippetsName: 'Extraits de texte',
            snippetsDesc:
                'S’appliquent à tout le texte collé après les règles intégrées. Activez ceux qui doivent s’exécuter lors du collage.',
            urlSnippetsName: 'Extraits de lien',
            urlSnippetsDesc:
                'S’appliquent à chaque lien collé une fois le titre de la page récupéré. Les règles ne voient que le lien Markdown final, et la destination reste inchangée.',
