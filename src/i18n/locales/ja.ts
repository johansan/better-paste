...
export const STRINGS_JA: TranslationStrings = {
    ...
    settings: {
        ...
        text: {
            ...
            invisibleAliases: ['ai', 'chatgpt', 'claude', 'llm', 'unicode', '不可視', 'nbsp', '空白'],
            ...
            quotesAliases: ['引用符', 'スマート引用符', 'まっすぐな引用符', 'アポストロフィ', '句読点', 'タイポグラフィ', 'ai'],
            quotesNone: '変更しない',
            ...
            dashesAliases: ['ダッシュ', 'em ダッシュ', 'en ダッシュ', 'ハイフン', '句読点', 'タイポグラフィ', 'ai'],
            dashesNone: '変更しない',
            dashesHyphen: 'ハイフン',
            dashesEn: 'en ダッシュ',
            dashesEm: 'em ダッシュ',
