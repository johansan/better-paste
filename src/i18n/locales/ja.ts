...
export const STRINGS_JA: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            savingDownloadDesc: 'ファイル名は既定でアドレスから取ります:',
            savingChoiceOff: '何もしない',
            savingChoiceLink: 'プレビュー付きでリンク',
            savingChoiceDownload: 'プレビュー付きでダウンロード',
            savingAliases: [
                'ダウンロード',
                'リンク',
                '埋め込み',
        ...
        links: {
            ...
            titlesDesc:
                'ウェブアドレスだけを貼り付けると、ページタイトルを付けた Markdown リンクを挿入します。Obsidian の URL を貼り付けると、ノート名を付けたリンクを挿入します。テキストを選択している場合は、そのテキストがラベルになり、タイトルは取得しません。タイトルを取得できないときはアドレスだけを残します。',
        ...
        custom: {
            ...
            snippetsName: 'テキストスニペット',
            snippetsDesc: '組み込みルールの後に、貼り付けたテキスト全体に適用されます。貼り付け時に実行するものをオンにします。',
            urlSnippetsName: 'リンクスニペット',
            urlSnippetsDesc:
                'ページタイトルの取得後に、貼り付けたリンクごとに適用されます。ルールは完成した Markdown リンクだけを対象にし、リンク先は変更されません。',
