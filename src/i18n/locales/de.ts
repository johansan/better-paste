...
export const STRINGS_DE: TranslationStrings = {
    commands: {
        paste: 'Einfügen',
        pasteRaw: 'Als Klartext einfügen',
    ...
    settings: {
        ...
        start: {
            ...
            showReleaseNotesName: 'Versionshinweise nach Updates anzeigen',
            showReleaseNotesDesc: 'Öffnet den Dialog mit den Neuerungen einmal nach jedem Update.',
            showReleaseNotesAliases: ['versionshinweise', 'neuerungen', 'update', 'dialog', 'popup', 'benachrichtigung'],
        ...
        custom: {
            ...
            snippetsDesc:
                'Werden nach den integrierten Regeln auf den gesamten eingefügten Text angewendet. Schalte diejenigen ein, die beim Einfügen laufen sollen.',
            urlSnippetsName: 'Link-Snippets',
            urlSnippetsDesc:
                'Werden auf jeden eingefügten Link angewendet, nachdem der Seitentitel abgerufen wurde. Die Regeln sehen nur den fertigen Markdown-Link, das Ziel bleibt unverändert.',
