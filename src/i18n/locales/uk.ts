...
export const STRINGS_UK: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            savingDesc:
                'Виберіть, чи вставляти зображення за посиланням прямо з вебу, чи завантажувати їх до теки вкладень. Стосується команди «Скопіювати зображення» в Safari, зображень у скопійованому вебвмісті та вставлених адрес зображень. Типово імʼя файлу походить з адреси:',
