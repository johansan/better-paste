...
export const STRINGS_UK: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            heading: 'Зображення',
            savingName: 'Зберігати вебзображення у сховище',
            savingDesc:
                'Зберігає вебзображення до теки вкладень і посилається на локальний файл замість вебадреси. Стосується «Копіювати зображення» в Safari, зображень у скопійованому вебвмісті та вставлених адрес зображень. Типово імʼя файлу походить з адреси:',
            savingAliases: ['завантажити', 'url', 'веб', 'вкладення', 'safari', 'локальний', 'зображення', 'тека'],
