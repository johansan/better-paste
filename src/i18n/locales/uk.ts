...
export const STRINGS_UK: TranslationStrings = {
    ...
    notices: {
        ...
        imagesFailedNothingPasted: '{images}, тому нічого не вставлено. Вміст залишився в буфері обміну.',
    ...
    settings: {
        ...
        start: {
            ...
            supportDesc: 'Якщо Better Paste вам корисний, підтримайте його подальшу розробку.',
        ...
        behavior: {
            ...
            autoCleanDesc:
                'Застосовує правила під час кожної вставки. Вимкніть, щоб користуватися лише командами. Окрему нотатку можна виключити властивістю "better-paste: false".',
            ...
            showNoticesDesc:
                'Однорядковий підсумок того, що було очищено. Про помилки повідомляється завжди, незалежно від цього значення.',
        ...
        images: {
            ...
            savingDesc:
                'Зберігає вставлені зображення як локальні файли замість зовнішніх посилань. Це стосується «Копіювати зображення» в Safari, зображень у скопійованому вебвмісті та окремих адрес зображень. Зображення потрапляють до теки вкладень вашого сховища. З варіантом «Назва з джерела»:',
            ...
            pageDesc: 'Імена файлів і ширина зображень для нотатки.',
            nameFormatName: 'Імена файлів',
            nameFormatDesc: 'Виберіть, як називатимуться збережені файли зображень.',
            ...
            sizePropertyDesc:
                'Властивість frontmatter, що задає ширину зображень, вставлених у нотатку. Нотатка з цією властивістю бере вставлення знімків екрана на себе замість Obsidian. Залиште порожнім, щоб вимкнути.',
        ...
        links: {
            ...
            titlesDesc:
                'Якщо в буфері обміну лише вебадреса, що не є зображенням, заголовок сторінки завантажується і вставляється посилання Markdown. Будь-який інший виділений текст стає підписом без мережевого запиту. Якщо заголовок отримати не вдалося, залишається початкова адреса.',
            titlesAliases: ['заголовок', 'сторінка', 'сайт', 'посилання markdown', 'завантажити'],
            cleaningName: 'Очищати вставлені посилання',
            cleaningDesc: 'Видаляє параметри відстеження зі вставлених посилань. Закреслену частину буде видалено:',
            cleaningAliases: ['url', 'відстеження', 'utm', 'параметри', 'запит', 'сайт', 'домен', 'youtube', 'виняток'],
            stripName: 'Які параметри видаляти',
            stripDesc:
                'Виберіть, видаляти всі параметри запиту чи лише відомі параметри відстеження. Правила сайтів можуть зберігати параметри в обох режимах.',
            stripAliases: ['utm', 'відстеження', 'запит', 'параметри'],
            stripAll: 'Усі параметри, крім збережених правилом сайту',
            stripTracking: 'Лише відомі параметри відстеження',
            rulesName: 'Правила збереження параметрів',
            rulesDesc: 'Правила сайтів для збереження певних параметрів запиту в обох режимах видалення.',
            rulesCount: {
                one: '{count} сайт',
                few: '{count} сайти',
                many: '{count} сайтів',
            ...
            listDesc:
                '{sites} вже опрацьовуються й оновлюються разом із плагіном. Додайте тут власні правила, по одному в рядку. «example.com» зберігає всі параметри цього сайту, «example.com: a, b» зберігає лише ці два, а «!example.com» скасовує правило, що постачається з плагіном. У режимі «Лише відомі параметри відстеження» правило рятує тільки відповідні параметри відстеження, бо решта й так зберігається. Піддомени враховуються автоматично.',
            listShippedCount: {
            ...
            testerDesc: 'Вставте посилання, щоб побачити, що збережуть ці правила.',
        ...
        terminal: {
            ...
            cleanupDesc:
                'Знову зʼєднує перенесені рядки виводу термінала й прибирає відступи. Коди кольору видаляються. Блоки коду, таблиці та елементи списків лишаються без змін.',
            ...
            pageDesc: 'Умови зʼєднання рядків і символи маркерів.',
            rejoinName: 'Коли зʼєднувати розірваний рядок',
            rejoinDesc: 'Умова, за якої рядок вважається продовженням попереднього.',
            rejoinAliases: ['відступ', 'перенесення', 'агресивно', 'безпечно', 'git log'],
            rejoinIndented: 'Лише якщо наступний рядок має відступ',
            rejoinAny: 'Щоразу, коли рядок вище виглядає заповненим',
            rejoinNever: 'Ніколи не зʼєднувати, лише прибирати коди й відступи',
            bulletsName: 'Символи маркерів',
            bulletsDesc:
                'Визначає, чи зберігаються символи маркерів (як-от •) у виводі термінала, чи перетворюються на елементи списку Markdown.',
            bulletsAliases: ['список', 'markdown', 'тире'],
            bulletsMarkdown: 'Перетворити на елементи списку Markdown',
            bulletsPreserve: 'Залишити як є',
            testerName: 'Спробуйте',
            testerDesc: 'Вставте вивід термінала, щоб побачити, як його буде очищено.',
        ...
        text: {
            ...
            commasDesc: 'Виберіть, де ставити кому поруч із закривальною подвійною лапкою.',
    ...
    welcome: {
        ...
        intro: [
            ...
            'Окрему нотатку можна повністю виключити властивістю "better-paste: false". Налаштування розташовані в розділі Налаштування, Better Paste.'
        ],
        startButton: 'Почати'
    },
