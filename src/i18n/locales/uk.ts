...
export const STRINGS_UK: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            customDesc:
                'Використовуйте {{name}} для назви джерела, {{noteName}} для назви нотатки, {{property:xyz}} для властивості з frontmatter, {{counter}} або {{counter:2}} для номера, що зростає, та формати дат Moment, наприклад YYYY-MM-DD. Знімок екрана не має назви джерела, тому його {{name}} стає «Pasted image» з міткою часу, як в Obsidian.',
