...
export const STRINGS_UK: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            savingDesc:
                'Виберіть, що відбувається під час вставлення зображень з вебу. «Нічого не робити» залишає вставлене як є, «Вставляти посилання з попереднім переглядом» показує зображення прямо з вебу, а «Завантажувати з попереднім переглядом» зберігає копію у сховищі, зокрема й зображень, скопійованих у Safari.',
