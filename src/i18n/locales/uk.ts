...
export const STRINGS_UK: TranslationStrings = {
    commands: {
        paste: 'Вставити',
        pasteRaw: 'Вставити як звичайний текст',
    ...
    settings: {
        ...
        images: {
            heading: 'Вкладення',
            fileModeName: 'Вставлені файли',
            fileModeDesc:
                'Виберіть, що відбувається під час вставлення файлів із вашого пристрою, наприклад PDF і знімків екрана. «Нічого не робити» залишає вставлення самому Obsidian, разом із попереднім переглядом. «Вставляти посилання без попереднього перегляду» прибирає знак оклику.',
            fileModeChoiceOff: 'Нічого не робити',
            fileModeChoiceLink: 'Вставляти посилання без попереднього перегляду',
            fileModeAliases: ['файл', 'вкладення', 'перегляд', 'вбудувати', 'посилання', 'pdf', 'знімок екрана', 'знак оклику'],
            ...
            namingInfoLead: 'Важливо! Better Paste не може:',
            namingInfoExplorer: 'Перейменувати файл, який ви копіюєте у Finder або Провіднику та вставляєте',
            namingInfoDrag: 'Перейменувати файл, який ви перетягуєте в нотатку',
            namingInfoMobile:
                'Обробити вставлення, зроблене власною командою Obsidian «Вставити» на мобільному пристрої. Замість неї використовуйте «{command}».',
        ...
        links: {
            ...
            titlesDesc:
                'Вставлення однієї вебадреси створює посилання Markdown із заголовком сторінки. Вставлення URL-адреси Obsidian створює посилання з назвою нотатки. Якщо виділено текст, він стає підписом, а заголовок не завантажується. Якщо заголовок отримати не вдалося, залишається сама адреса.',
