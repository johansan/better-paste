...
export const STRINGS_UK: TranslationStrings = {
    ...
    settings: {
        ...
        text: {
            ...
            quotesName: 'Лапки',
            quotesDesc: 'Перетворює лапки й апострофи на цей стиль.',
            quotesAliases: ['лапки', 'фігурні лапки', 'прямі лапки', 'апостроф', 'пунктуація', 'типографіка', 'ші'],
            quotesNone: 'Без змін',
            quotesStraight: 'Прямі лапки',
            quotesCurly: 'Фігурні лапки',
            quotesExample: '“Готово,” сказала вона. Усе "добре".',
            dashesName: 'Тире',
            dashesDesc: 'Перетворює тире між словами на цей стиль.',
            dashesAliases: ['тире', 'довге тире', 'середнє тире', 'дефіс', 'пунктуація', 'типографіка', 'ші'],
            dashesNone: 'Без змін',
            dashesHyphen: 'Дефіси',
