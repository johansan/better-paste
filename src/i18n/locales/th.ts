...
export const STRINGS_TH: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            savingDesc:
                'เลือกได้ว่าจะลิงก์รูปภาพจากเว็บโดยตรง หรือดาวน์โหลดลงในโฟลเดอร์ไฟล์แนบของคุณ ครอบคลุมทั้ง "คัดลอกรูปภาพ" ของ Safari รูปภาพในเนื้อหาเว็บที่คัดลอกมา และที่อยู่รูปภาพที่วาง โดยค่าเริ่มต้นชื่อไฟล์มาจากที่อยู่:',
