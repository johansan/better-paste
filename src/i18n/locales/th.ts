...
export const STRINGS_TH: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            heading: 'รูปภาพ',
            savingName: 'บันทึกรูปภาพจากเว็บลงในห้องนิรภัย',
            savingDesc:
                'บันทึกรูปภาพจากเว็บลงในโฟลเดอร์ไฟล์แนบของคุณ และลิงก์ไปยังไฟล์ในเครื่องแทนที่อยู่เว็บ ครอบคลุมทั้ง "คัดลอกรูปภาพ" ของ Safari รูปภาพในเนื้อหาเว็บที่คัดลอกมา และที่อยู่รูปภาพที่วาง โดยค่าเริ่มต้นชื่อไฟล์มาจากที่อยู่:',
            savingAliases: ['ดาวน์โหลด', 'url', 'เว็บ', 'ไฟล์แนบ', 'safari', 'ในเครื่อง', 'รูปภาพ', 'โฟลเดอร์'],
