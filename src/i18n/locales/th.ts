...
export const STRINGS_TH: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            customDesc:
                'ใช้ {{name}} แทนชื่อต้นทาง {{noteName}} แทนชื่อโน้ต {{property:xyz}} แทนคุณสมบัติใน frontmatter {{counter}} หรือ {{counter:2}} แทนตัวเลขที่เพิ่มขึ้น และรูปแบบวันที่ของ Moment เช่น YYYY-MM-DD ภาพหน้าจอไม่มีชื่อต้นทาง ดังนั้น {{name}} จึงกลายเป็น "Pasted image" พร้อมประทับเวลา เช่นเดียวกับใน Obsidian',
