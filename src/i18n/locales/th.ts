...
export const STRINGS_TH: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            heading: 'ไฟล์แนบ',
            fileModeName: 'ไฟล์ที่วาง',
            fileModeDesc:
                'เลือกว่าจะให้เกิดอะไรขึ้นเมื่อคุณวางไฟล์จากอุปกรณ์ เช่น PDF และภาพหน้าจอ "ไม่ต้องทำอะไร" จะปล่อยให้ Obsidian จัดการการวางเอง รวมถึงการแสดงตัวอย่างด้วย ส่วน "ลิงก์โดยไม่แสดงตัวอย่าง" จะลบเครื่องหมายตกใจออก',
            fileModeChoiceOff: 'ไม่ต้องทำอะไร',
            fileModeChoiceLink: 'ลิงก์โดยไม่แสดงตัวอย่าง',
            fileModeAliases: ['ไฟล์', 'ไฟล์แนบ', 'ตัวอย่าง', 'ฝัง', 'ลิงก์', 'pdf', 'ภาพหน้าจอ', 'เครื่องหมายตกใจ'],
            savingName: 'รูปภาพจากเว็บ',
            savingDesc:
                'เลือกว่าจะให้เกิดอะไรขึ้นเมื่อคุณวางลิงก์รูปภาพจากเว็บ "ไม่ต้องทำอะไร" จะปล่อยสิ่งที่วางไว้ตามเดิม "ลิงก์พร้อมแสดงตัวอย่าง" จะแสดงรูปภาพจากเว็บโดยตรง และ "ดาวน์โหลดพร้อมแสดงตัวอย่าง" จะบันทึกสำเนาลงในห้องนิรภัยของคุณ',
            savingDownloadDesc: 'โดยค่าเริ่มต้นชื่อไฟล์มาจากที่อยู่:',
            savingChoiceOff: 'ไม่ต้องทำอะไร',
            savingChoiceLink: 'ลิงก์พร้อมแสดงตัวอย่าง',
            savingChoiceDownload: 'ดาวน์โหลดพร้อมแสดงตัวอย่าง',
            savingAliases: ['ดาวน์โหลด', 'ลิงก์', 'ฝัง', 'ตัวอย่าง', 'url', 'เว็บ', 'ไฟล์แนบ', 'safari', 'ในเครื่อง', 'รูปภาพ', 'โฟลเดอร์'],
            sizeStyleName: 'ขนาดและสไตล์',
            sizeStyleDesc: 'เพิ่มความกว้างหรือคลาส CSS ให้รูปภาพที่วาง จะให้ใส่อัตโนมัติหรือเลือกเองแต่ละครั้งก็ได้',
            sizeStyleAliases: ['ขนาด', 'ความกว้าง', 'css', 'คลาส', 'สไตล์', 'ปรับขนาด', 'invert'],
            summarySize: 'ขนาด: {value}',
            summaryStyle: 'สไตล์: {value}',
            summaryAsk: 'ถาม',
        ...
        links: {
            ...
            titlesDesc:
                'การวางที่อยู่เว็บเพียงลำพังจะแทรกลิงก์ Markdown พร้อมชื่อหน้าเว็บ การวาง URL ของ Obsidian จะแทรกลิงก์พร้อมชื่อโน้ต หากมีข้อความที่เลือกไว้ ข้อความนั้นจะกลายเป็นป้ายกำกับและไม่มีการดึงชื่อเรื่อง หากดึงชื่อเรื่องไม่ได้ จะคงที่อยู่ล้วน ๆ ไว้',
        ...
        structure: {
            heading: 'โครงสร้าง',
            listNestingName: 'คงการซ้อนของรายการเมื่อวาง',
            listNestingDesc: 'วางรายการที่คัดลอกโดยคงลำดับชั้นไว้ครบ และปรับการเยื้องให้ตรงกับรายการตรงจุดที่คุณวาง',
            listNestingAliases: ['รายการ', 'ซ้อน', 'เยื้อง', 'ลำดับชั้น', 'โครงร่าง', 'หัวข้อย่อย', 'ช่องทำเครื่องหมาย', 'ต้นไม้'],
            quoteContinuationName: 'ต่อข้อความอ้างอิงแบบบล็อกเมื่อวาง',
            quoteContinuationDesc:
                'วางข้อความหลายบรรทัดลงในบรรทัดอ้างอิง โดยใส่เครื่องหมายอ้างอิงให้ทุกบรรทัด เพื่อให้ข้อความที่วางทั้งหมดยังคงอยู่ในข้อความอ้างอิงแบบบล็อกหรือบล็อกเน้น',
            quoteContinuationAliases: ['อ้างอิง', 'ข้อความอ้างอิงแบบบล็อก', 'บล็อกเน้น', 'คำคม', 'คำเตือน', 'ย่อหน้า']
        },
        ...
        custom: {
            ...
            snippetsName: 'ชุดคำสั่งข้อความ',
            snippetsDesc: 'ใช้กับข้อความที่วางทั้งหมดหลังจากกฎในตัวทำงานแล้ว เปิดใช้ชุดที่ต้องการให้ทำงานเมื่อวาง',
            urlSnippetsName: 'ชุดคำสั่งลิงก์',
            urlSnippetsDesc:
                'ใช้กับลิงก์ที่วางแต่ละลิงก์หลังจากดึงชื่อหน้าเว็บแล้ว กฎจะเห็นเฉพาะลิงก์ Markdown ที่เสร็จแล้ว และปลายทางของลิงก์จะไม่เปลี่ยน',
    ...
    overlap: {
        ...
        intro: {
            other: 'ตอนนี้คุณมีปลั๊กอินที่ทำงานแทบเหมือนกับ Better Paste ติดตั้งอยู่ {count} ตัว โปรดปิดใช้งานหรือถอนการติดตั้งปลั๊กอินต่อไปนี้:'
        },
