...
export const STRINGS_TH: TranslationStrings = {
    ...
    settings: {
        ...
        text: {
            ...
            quotesAliases: ['อัญประกาศ', 'อัญประกาศโค้ง', 'อัญประกาศตรง', 'อะพอสทรอฟี', 'เครื่องหมายวรรคตอน', 'การพิมพ์', 'ai'],
            quotesNone: 'ไม่เปลี่ยนแปลง',
            quotesStraight: 'อัญประกาศตรง',
            quotesCurly: 'อัญประกาศโค้ง',
            quotesExample: '“เสร็จแล้ว,” ถัดไปคือ "รอดำเนินการ"',
            dashesName: 'ขีด',
            dashesDesc: 'เปลี่ยนขีดระหว่างคำให้เป็นรูปแบบนี้',
            dashesAliases: ['ขีด', 'ขีดยาว', 'ขีดกลาง', 'ยัติภังค์', 'เครื่องหมายวรรคตอน', 'การพิมพ์', 'ai'],
            dashesNone: 'ไม่เปลี่ยนแปลง',
            dashesHyphen: 'ยัติภังค์',
            dashesEn: 'ขีดกลาง',
            dashesEm: 'ขีดยาว',
            dashesEmSpaced: 'ขีดยาวมีวรรค',
            dashesExample: 'ผลลัพธ์ - แม้ทุกอย่างจะขวางอยู่ — ออกมาดี'
        }
    },
