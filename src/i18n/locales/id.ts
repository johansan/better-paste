...
export const STRINGS_ID: TranslationStrings = {
    ...
    settings: {
        ...
        text: {
            ...
            quotesDesc: 'Mengubah tanda kutip dan apostrof ke gaya ini.',
            quotesAliases: ['tanda kutip', 'tanda kutip melengkung', 'tanda kutip lurus', 'apostrof', 'tanda baca', 'tipografi', 'ai'],
            ...
            dashesDesc: 'Mengubah tanda pisah di antara kata ke gaya ini.',
            dashesAliases: ['tanda pisah', 'tanda pisah panjang', 'tanda hubung', 'tanda baca', 'tipografi', 'ai'],
