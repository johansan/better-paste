...
export const STRINGS_PT: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            heading: 'Anexos',
            fileModeName: 'Ficheiros colados',
            fileModeDesc:
                'Escolha o que acontece quando cola ficheiros do seu dispositivo, como PDF e capturas de ecrã. "Não fazer nada" deixa a colagem ao cuidado do Obsidian, pré-visualização incluída. "Ligar sem pré-visualização" remove o ponto de exclamação.',
            fileModeChoiceOff: 'Não fazer nada',
            fileModeChoiceLink: 'Ligar sem pré-visualização',
            fileModeAliases: [
                'ficheiro',
                'anexo',
                'pré-visualização',
            ...
            savingDesc:
                'Escolha o que acontece quando cola ligações para imagens da web. "Não fazer nada" deixa a colagem como está, "Ligar com pré-visualização" mostra a imagem diretamente da web e "Descarregar com pré-visualização" guarda uma cópia no seu cofre.',
            savingDownloadDesc: 'Por predefinição, o nome do ficheiro vem do endereço:',
            ...
            namingInfoTitle: 'Quando o formato do nome de ficheiro se aplica',
            namingInfoLead: 'Importante! O Better Paste não pode fazer o seguinte:',
            namingInfoExplorer: 'Renomear um ficheiro que copia no Finder ou no Explorador de Ficheiros e cola',
            namingInfoDrag: 'Renomear um ficheiro que arrasta para uma nota',
            namingInfoMobile: 'Processar o que é colado com o comando Colar do Obsidian no telemóvel. Use "{command}" em vez disso.',
        ...
        links: {
            ...
            titlesDesc:
                'Colar um endereço web isolado insere uma ligação Markdown com o título da página. Colar um URL do Obsidian insere uma ligação com o nome da nota. Se houver texto selecionado, esse texto passa a ser o rótulo e nenhum título é obtido. O endereço simples é mantido quando o título não pode ser obtido.',
