...
export const STRINGS_AR: TranslationStrings = {
    ...
    overlap: {
        ...
        intro: {
            zero: 'لديك حاليًا {count} إضافات مثبتة تقوم بالمهمة نفسها تقريبًا، لذا عطّل أو أزِل ما يلي:',
            one: 'لديك حاليًا {count} إضافة مثبتة تقوم بالمهمة نفسها تقريبًا، لذا عطّل أو أزِل ما يلي:',
            two: 'لديك حاليًا {count} إضافة مثبتة تقومان بالمهمة نفسها تقريبًا، لذا عطّل أو أزِل ما يلي:',
            few: 'لديك حاليًا {count} إضافات مثبتة تقوم بالمهمة نفسها تقريبًا، لذا عطّل أو أزِل ما يلي:',
            many: 'لديك حاليًا {count} إضافةً مثبتة تقوم بالمهمة نفسها تقريبًا، لذا عطّل أو أزِل ما يلي:',
            other: 'لديك حاليًا {count} إضافة مثبتة تقوم بالمهمة نفسها تقريبًا، لذا عطّل أو أزِل ما يلي:'
        },
