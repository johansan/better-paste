...
export const STRINGS_AR: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            savingDesc:
                'اختر بين ربط الصور مباشرة من الويب وتنزيلها في مجلد المرفقات. يشمل «نسخ الصورة» في Safari، والصور داخل محتوى ويب منسوخ، وعناوين الصور الملصقة. يأتي اسم الملف من العنوان افتراضيًا:',
