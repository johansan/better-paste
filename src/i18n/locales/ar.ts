...
export const STRINGS_AR: TranslationStrings = {
    ...
    settings: {
        ...
        terminal: {
            ...
            cleanupDesc:
                'يعيد وصل الأسطر التي قطعتها الطرفية، ويزيل رموز الألوان والمسافات البادئة في أول السطر. كتل الشيفرة والجداول والقوائم تبقى كما هي.',
            cleanupAliases: ['التفاف', 'وصل', 'ansi', 'طرفية', 'صدفة', 'مسافة بادئة', 'تعداد نقطي', 'قائمة', 'markdown'],
            pageName: 'معالجة نص الطرفية',
            pageDesc: 'وصل الأسطر ورموز التعداد النقطي.',
            rejoinName: 'متى يُعاد وصل سطر مقطوع',
            rejoinDesc: 'لا يُوصل السطر بالسطر الذي قبله إلا إذا بدا ذلك السطر ممتلئًا.',
            rejoinAliases: ['مسافة بادئة', 'التفاف', 'جريء', 'آمن', 'git log'],
            rejoinIndented: 'فقط إذا كان السطر يبدأ بمسافة بادئة',
            rejoinAny: 'سواء كان السطر بمسافة بادئة أم لا',
            rejoinNever: 'أبدًا، أزل الرموز والمسافات البادئة فقط',
            bulletsName: 'رموز التعداد النقطي',
            bulletsDesc: 'ماذا يحدث لرموز التعداد النقطي مثل • في مخرجات الطرفية.',
            bulletsAliases: ['قائمة', 'markdown', 'شرطة'],
            bulletsMarkdown: 'التحويل إلى عناصر قائمة Markdown',
            bulletsPreserve: 'اتركها كما هي',
            testerName: 'جرّبها',
            testerDesc: 'الصق مخرجات طرفية لترى كيف تُنظَّف.',
        ...
        text: {
            ...
            commasName: 'الفواصل',
            commasDesc: 'موضع الفاصلة بجوار علامة اقتباس مزدوجة مغلقة.',
            ...
            invisibleName: 'المحارف غير المرئية',
            ...
            quotesAliases: ['علامة اقتباس', 'اقتباس منحني', 'اقتباس مستقيم', 'فاصلة عليا', 'ترقيم', 'طباعة', 'ذكاء اصطناعي'],
            quotesNone: 'بدون تغيير',
            quotesStraight: 'علامات اقتباس مستقيمة',
            quotesCurly: 'علامات اقتباس منحنية',
            quotesExample: '“اكتمل,” ثم جاء "التالي".',
            dashesName: 'الشرطات',
            dashesDesc: 'يحوّل الشرطات بين الكلمات إلى هذا النمط.',
            dashesAliases: ['شرطة', 'شرطة طويلة', 'شرطة متوسطة', 'واصلة', 'ترقيم', 'طباعة', 'ذكاء اصطناعي'],
            dashesNone: 'بدون تغيير',
            dashesHyphen: 'واصلات',
            dashesEn: 'شرطات متوسطة',
