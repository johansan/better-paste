...
export const STRINGS_AR: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            namingInfoLead: 'مهم! لا يستطيع Better Paste إعادة تسمية الملفات في هاتين الحالتين:',
            namingInfoExplorer: 'انسخ ملفًا في Finder أو مستكشف الملفات وألصقه',
            namingInfoDrag: 'اسحب ملفًا إلى ملاحظة',
