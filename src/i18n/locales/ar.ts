...
export const STRINGS_AR: TranslationStrings = {
    ...
    settings: {
        ...
        images: {
            ...
            savingDesc:
                'اختر ما يحدث عند لصق صور من الويب. «لا تفعل شيئًا» يترك اللصق كما هو، و«ربط مع معاينة» يعرض الصورة مباشرة من الويب، و«تنزيل مع معاينة» يحفظ نسخة في خزنتك، بما في ذلك الصور المنسوخة في Safari.',
