...
export const STRINGS_ZH_CN: TranslationStrings = {
    ...
    settings: {
        ...
        text: {
            ...
            invisibleAliases: ['ai', 'chatgpt', 'claude', 'llm', 'unicode', '不可见', 'nbsp', '空白'],
            invisibleExampleStart: '结果是',
            invisibleExampleMiddle: 'OK',
            invisibleExampleEnd: '。',
            invisibleExampleAfter: '结果是 OK。',
            quotesName: '引号',
            quotesDesc: '把引号和撇号换成这种样式。',
            quotesAliases: ['引号', '弯引号', '直引号', '撇号', '标点', '排版', 'ai'],
            quotesNone: '不做改动',
            quotesStraight: '直引号',
            quotesCurly: '弯引号',
            quotesExample: '“完成,” 之后是 "待办"。',
            dashesName: '破折号',
            dashesDesc: '把词语之间的破折号换成这种样式。',
            dashesAliases: ['破折号', '长破折号', '连接号', '连字符', '标点', '排版', 'ai'],
            dashesNone: '不做改动',
            dashesHyphen: '连字符',
            dashesEn: '连接号',
            dashesEm: '长破折号',
            dashesEmSpaced: '带空格的长破折号',
